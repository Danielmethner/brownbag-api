...
public class BalanceController {
	...
	private List<JsonObjBalSheet> jpaToJson(List<ObjBalSheet> jpaBalSheets) {
		...
		for (ObjBalSheet jpaBalSheet : jpaBalSheets) {
			...
			jsonBalSheet.setSectionAssets(balSheetSectionSvc.getByBalSheetAndSection(jpaBalSheet, EBalSheetSectionType.ASSETS));
			jsonBalSheet.setSectionLiablities(balSheetSectionSvc.getByBalSheetAndSection(jpaBalSheet, EBalSheetSectionType.LIABILITIES));
			jsonBalSheet.setSectionEquity(balSheetSectionSvc.getByBalSheetAndSection(jpaBalSheet, EBalSheetSectionType.EQUITY));
