...
public enum EOrderStatus {
	NEW("New", true), OPEN("Open", true), HOLD("Hold", true), PLACED("Placed", true),
	EXEC_FULL("Fully Executed", false), EXEC_PART("Partially Executed", false), DONE("Done", false),
	DISC("Discarded", false);
